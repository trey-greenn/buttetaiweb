      ...
      <div className="bg-[#f9f7f1] text-[#2f2f2f] font-serif min-h-screen">
        ...
        <div className="text-center relative px-4">
          <div className="relative">
            <h1 className="font-playfair font-black text-[50px] md:text-[80px] uppercase inline-block leading-[50px] md:leading-[72px] my-5">Buffetai</h1>
          </div>

          <div className="uppercase border-b-2 border-t-2 border-[#2f2f2f] text-[24px] md:text-[36px] py-3">Improving Information Diets</div>
        </div>

        {/* Content Section */}
        <div className="m-[20px_auto_0] w-full px-4">
          <div className="flex flex-col">
            {/* Column 1 Tooling Section*/}
            <div className="w-full text-sm leading-5 p-[0_1%] align-top mb-[30px] md:mb-[50px] border-b border-[#2f2f2f] pb-6">
              <div className="text-center">
                <Link href ='/tools'>
                    <h2 className="font-playfair font-normal italic text-[30px] md:text-[36px] p-[10px_0] block mx-auto">Check Out Our Tools</h2>
                </Link>
            ...
            <div className="w-full text-sm leading-5 p-[0_1%] align-top mb-[30px] md:mb-[50px] border-b border-[#2f2f2f] pb-6">
              <div className="text-center">
                <Link href='/about'>
                    <h2 className="font-playfair font-normal text-[36px] md:text-[42px] uppercase italic p-[10px_0] block mx-auto">What are we about?</h2>
                </Link>
            ...
            <div className="w-full text-sm leading-5 p-[0_1%] align-top mb-[30px] md:mb-[50px] border-b border-[#2f2f2f] pb-6">
              <div className="text-center">
                <Link href='/blog'>
                <h2 className="font-playfair font-bold text-[26px] md:text-[30px] uppercase p-[10px_0] block mx-auto">Catch Up With Our Blog!</h2>
                </Link>
                <p className="font-playfair font-normal italic text-[20px] md:text-[24px] p-[10px_0] before:border-t before:border-[#2f2f2f] before:content-[''] before:w-[100px] before:h-[7px] before:block before:mx-auto after:border-b after:border-[#2f2f2f] after:content-[''] after:w-[100px] after:h-[13px] after:block after:mx-auto">Latest insights and updates</p>
              </div>
              ...
              <p className="mt-0 mb-5">Our team of experts regularly publishes in-depth analyses and case studies that showcase the real-world impact of AI technologies. 
                <span className="font-playfair text-[28px] md:text-[36px] leading-[36px] md:leading-[44px] text-center font-normal block my-10 mx-0 before:border-t before:border-[#2f2f2f] before:content-[''] before:w-[100px] before:h-4 before:block before:mx-auto after:border-b after:border-[#2f2f2f] after:content-[''] after:w-[100px] after:h-4 after:block after:mx-auto">
            ...
            <div className="w-full text-sm leading-5 p-[0_1%] align-top mb-[30px] md:mb-[50px] border-b border-[#2f2f2f] pb-6">
              <div className="text-center">
                <Link href='/pricing'>
                <h2 className="font-playfair font-normal italic text-[30px] md:text-[36px] p-[10px_0] block mx-auto">Pricing of Services</h2>
                </Link>
            ...
            {/* Column 5 Followers */}
            <div className="w-full text-sm leading-5 p-[0_1%] align-top mb-[30px] md:mb-[50px]">
              <div className="text-center">
                <Link href='/follow'>
                    <h2 className="font-playfair font-bold text-[26px] md:text-[30px] uppercase p-[10px_0] block mx-auto">Join Our Community!</h2>
                </Link>
